...
public:
    ...
    {
        state = _makePromiseOutgoing<TBaseState>(true, this, &GenericBasePrx::_iceI_getBaseState, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getBaseStateAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<TBaseState>>().get_future())
    {
        return _makePromiseOutgoing<TBaseState, P>(false, this, &GenericBasePrx::_iceI_getBaseState, context);
    }

    ::std::function<void()>
    getBaseStateAsync(::std::function<void(TBaseState)> response,
                      ::std::function<void(::std::exception_ptr)> ex = nullptr,
                      ::std::function<void(bool)> sent = nullptr,
                      const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<TBaseState>(response, ex, sent, this, &GenericBasePrx::_iceI_getBaseState, context);
    }

    /// \cond INTERNAL
    void _iceI_getBaseState(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<TBaseState>>&, const ::Ice::Context&);
    /// \endcond
                     ...
                     const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        ...
        return _makeLamdaOutgoing<GenericBase::GetBasePoseResult>(_responseCb, ex, sent, this, &GenericBasePrx::_iceI_getBasePose, context);
    }
