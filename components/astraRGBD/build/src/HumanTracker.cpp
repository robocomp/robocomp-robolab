...
/// \cond INTERNAL
void
RoboCompHumanTracker::HumanTrackerPrx::_iceI_getJointDepthPosition(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<HumanTracker::GetJointDepthPositionResult>>& outAsync, int iceP_idperson, const ::std::string& iceP_idjoint, const ::Ice::Context& context)
{
    ...
    outAsync->invoke(iceC_RoboCompHumanTracker_HumanTracker_getJointDepthPosition_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        ...
        {
            HumanTracker::GetJointDepthPositionResult v;
...
void IceProxy::RoboCompHumanTracker::HumanTracker::_iceI_end_getJointDepthPosition(::RoboCompHumanTracker::joint& iceP_depthjoint, bool& ret, const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_RoboCompHumanTracker_HumanTracker_getJointDepthPosition_name);
    if(!result->_waitForResponse())
    {
