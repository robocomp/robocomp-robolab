...
# \mainpage RoboComp::camerasimpleclient
#
...
#
# Just: "${PATH_TO_BINARY}/camerasimpleclient --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
	...
	try:
		...
		try:
			...
			try:
				...
				camerasimple_proxy = RoboCompCameraSimple.CameraSimplePrx.checkedCast(basePrx)
