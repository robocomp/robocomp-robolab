...
# \mainpage RoboComp::camerasmuecas
#
...
#
# Just: "${PATH_TO_BINARY}/camerasmuecas --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	adapter = ic.createObjectAdapter('CamerasMuecas')
	adapter.add(CamerasMuecasI(worker), ic.stringToIdentity('camerasmuecas'))
	adapter.activate()
