...
/** \mainpage RoboComp::delfos
 *
 * \section intro_sec Introduction
 *
 * The delfos component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/delfos --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class delfos : public RoboComp::Application
{
public:
	delfos (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::delfos::run(int argc, char* argv[])
{
