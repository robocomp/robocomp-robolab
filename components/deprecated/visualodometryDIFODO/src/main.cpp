...
/** \mainpage RoboComp::visualodometryDIFODO
 *
 * \section intro_sec Introduction
 *
 * The visualodometryDIFODO component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/visualodometryDIFODO --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class visualodometryDIFODO : public RoboComp::Application
{
public:
	visualodometryDIFODO (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void visualodometryDIFODO::initialize()
{
...
int main(int argc, char* argv[])
{
	...
	visualodometryDIFODO app(prefix);
