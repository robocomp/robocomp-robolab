...
setattr(RoboCompImageBasedGestureRecognition, "ImgType", ImgType)
...
setattr(RoboCompImageBasedGestureRecognition, "floatList", floatList)
class intList(list):
    def __init__(self, iterable=list()):
...
setattr(RoboCompImageBasedGestureRecognition, "intList", intList)

import imagebasedgesturerecognitionI
...
class Implements:
    def __init__(self, ice_connector, default_handler):
        self.ice_connector = ice_connector
        self.imagebasedgesturerecognition = self.create_adapter("ImageBasedGestureRecognition", imagebasedgesturerecognitionI.ImageBasedGestureRecognitionI(default_handler))
