 ...
 *
 * Just: "${PATH_TO_BINARY}/caca --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class caca : public RoboComp::Application
{
public:
	caca (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::caca::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::caca app(prefix, startup_check_flag);
