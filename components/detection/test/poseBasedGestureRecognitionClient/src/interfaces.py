...
class Requires:
    def __init__(self, ice_connector):
        ...
        self.PoseBasedGestureRecognition = self.create_proxy("PoseBasedGestureRecognitionProxy", RoboCompPoseBasedGestureRecognition.PoseBasedGestureRecognitionPrx)
