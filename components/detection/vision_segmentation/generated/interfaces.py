...
Ice.loadSlice("-I ./generated/ --all ./generated/ImageSegmentation.ice")
import RoboCompImageSegmentation
...
class ObjectList(list):
    ...
    def append(self, item):
        assert isinstance(item, RoboCompImageSegmentation.SegmentedObject)
...
setattr(RoboCompImageSegmentation, "ObjectList", ObjectList)
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.imagesegmentation = self.create_adapter("ImageSegmentation", imagesegmentationI.ImageSegmentationI(default_handler, ""), parameters["Endpoints"]["ImageSegmentation"])
