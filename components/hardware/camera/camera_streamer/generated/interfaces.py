...
Ice.loadSlice("-I ./generated/ --all ./generated/CameraSimple.ice")
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.camerasimple = self.create_adapter("CameraSimple", camerasimpleI.CameraSimpleI(default_handler, ""), parameters["Endpoints"]["CameraSimple"])
