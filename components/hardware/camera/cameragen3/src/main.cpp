...
/** \mainpage RoboComp::cameragen3
 *
 * \section intro_sec Introduction
 *
 * The cameragen3 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/cameragen3 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class cameragen3 : public RoboComp::Application
{
public:
	cameragen3 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::cameragen3::run(int argc, char* argv[])
{
