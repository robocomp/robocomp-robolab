...
/** \mainpage RoboComp::Dreamvu
 *
 * \section intro_sec Introduction
 *
 * The Dreamvu component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/Dreamvu --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	Dreamvu (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::Dreamvu::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::Dreamvu app(prefix, startup_check_flag);
