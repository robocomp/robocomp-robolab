...
class SpecificWorker : public GenericWorker
{
    ...
    private:
        ...
        struct CONSTANTS
        {
            ...
            int width = 848; //848 424 1280
            int height = 480; //480 240 720
        };
        CONSTANTS consts;
       ...
       //Path
        ...
        cv::Mat mosaic(const Camera_Map &cam_map);
        ...
        DoubleBuffer< RoboCompCameraRGBDSimple::TImage,  RoboCompCameraRGBDSimple::TImage> buffer_image;
        DoubleBuffer< RoboCompCameraRGBDSimple::TDepth,  RoboCompCameraRGBDSimple::TDepth> buffer_depth;
};
