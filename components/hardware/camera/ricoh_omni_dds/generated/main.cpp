...
/** \mainpage RoboComp::ricoh_omni_dds
 *
 * \section intro_sec Introduction
 *
 * The ricoh_omni_dds component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/ricoh_omni_dds --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "ricoh_omni_dds"
#define SERVER_FULL_NAME   "RoboComp ricoh_omni_dds::ricoh_omni_dds"
...
class ricoh_omni_dds : public Ice::Application
{
public:
	ricoh_omni_dds (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData ricoh_omni_dds::getInitializationDataIce(){
...
void ricoh_omni_dds::initialize()
{
...
int ricoh_omni_dds::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	ricoh_omni_dds app(configFile, prefix, startup_check_flag);
