...
/** \mainpage RoboComp::three_vertical_realsense_camera
 *
 * \section intro_sec Introduction
 *
 * The three_vertical_realsense_camera component...
 *
 ...
 * cd three_vertical_realsense_camera
 * <br>
 * cmake . && make
 * <br>
 * To install:
 ...
 *
 * Just: "${PATH_TO_BINARY}/three_vertical_realsense_camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class three_vertical_realsense_camera : public RoboComp::Application
{
public:
	three_vertical_realsense_camera (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::three_vertical_realsense_camera::initialize()
{
...
int ::three_vertical_realsense_camera::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::three_vertical_realsense_camera app(prefix, startup_check_flag);
