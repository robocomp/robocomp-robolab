...
/** \mainpage RoboComp::usb_camera
 *
 * \section intro_sec Introduction
 *
 * The usb_camera component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/usb_camera --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class usb_camera : public RoboComp::Application
{
public:
	usb_camera (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::usb_camera::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::usb_camera app(prefix, startup_check_flag);
