...
void SpecificMonitor::readConfig(RoboCompCommonBehavior::ParameterList &params )
{
	...
	configGetString( "Joy","ZMotionAxis", aux.value, "2");
	params["ZMotionAxis"] = aux;
	configGetString( "Joy","SampleRate", aux.value, "5");
	params["SampleRate"] = aux;
	configGetString( "Joy","MaxAdvanceX", aux.value, "120");
	params["MaxAdvanceX"] = aux;
	configGetString( "Joy","MaxAdvanceZ", aux.value, "120");
	params["MaxAdvanceZ"] = aux;
