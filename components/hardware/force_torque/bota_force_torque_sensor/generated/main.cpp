...
/** \mainpage RoboComp::bota_force_sensor
 *
 * \section intro_sec Introduction
 *
 * The bota_force_sensor component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/bota_force_sensor --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "bota_force_sensor"
#define SERVER_FULL_NAME   "RoboComp bota_force_sensor::bota_force_sensor"
...
class bota_force_sensor : public Ice::Application
{
public:
	bota_force_sensor (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData bota_force_sensor::getInitializationDataIce(){
...
void bota_force_sensor::initialize()
{
...
int bota_force_sensor::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		//Implement code
		implement<ForceTorqueSensorI>(communicator(),
		                    configLoader.get<std::string>("Endpoints.ForceTorqueSensor"), 
		                    "forcetorquesensor", worker,  0);
...
int main(int argc, char* argv[])
{
	...
	bota_force_sensor app(configFile, prefix, startup_check_flag);
