...
/** \mainpage RoboComp::sbg_ekinox
 *
 * \section intro_sec Introduction
 *
 * The sbg_ekinox component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/sbg_ekinox --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class sbg_ekinox : public RoboComp::Application
{
public:
	sbg_ekinox (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::sbg_ekinox::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::sbg_ekinox app(prefix, startup_check_flag);
