...
Like any other component, lidar3DFilter requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/lidar3DFilter etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of lidar3DFilter, including what can be modified and how to use key features.
## Editable Files
