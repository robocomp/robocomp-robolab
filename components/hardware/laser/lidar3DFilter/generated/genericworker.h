...
using TuplePrx = std::tuple<RoboCompKinovaArm::KinovaArmPrxPtr,RoboCompKinovaArm::KinovaArmPrxPtr,RoboCompLidar3D::Lidar3DPrxPtr,RoboCompLidar3D::Lidar3DPrxPtr>;
...
public:
	...
	RoboCompKinovaArm::KinovaArmPrxPtr kinovaarm1_proxy;
