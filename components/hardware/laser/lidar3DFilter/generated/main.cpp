...
/** \mainpage RoboComp::lidar3DFilter
 *
 * \section intro_sec Introduction
 *
 * The lidar3DFilter component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/lidar3DFilter --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "lidar3DFilter"
#define SERVER_FULL_NAME   "RoboComp lidar3DFilter::lidar3DFilter"
...
class lidar3DFilter : public Ice::Application
{
public:
	lidar3DFilter (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData lidar3DFilter::getInitializationDataIce(){
...
int lidar3DFilter::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	RoboCompKinovaArm::KinovaArmPrxPtr kinovaarm_proxy1;
	...
	require<RoboCompKinovaArm::KinovaArmPrx, RoboCompKinovaArm::KinovaArmPrxPtr>(communicator(),
	                    configLoader.get<std::string>("Proxies.KinovaArm1"), "KinovaArmProxy1", kinovaarm_proxy1);
	...
	tprx = std::make_tuple(kinovaarm_proxy,kinovaarm_proxy1,lidar3d_proxy,lidar3d_proxy1);
...
int main(int argc, char* argv[])
{
	...
	lidar3DFilter app(configFile, prefix, startup_check_flag);
