...
/** \mainpage RoboComp::lidar3d_dds
 *
 * \section intro_sec Introduction
 *
 * The lidar3d_dds component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/lidar3d_dds --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "lidar3d_dds"
#define SERVER_FULL_NAME   "RoboComp lidar3d_dds::lidar3d_dds"
...
class lidar3d_dds : public Ice::Application
{
public:
	lidar3d_dds (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData lidar3d_dds::getInitializationDataIce(){
...
int lidar3d_dds::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	lidar3d_dds app(configFile, prefix, startup_check_flag);
