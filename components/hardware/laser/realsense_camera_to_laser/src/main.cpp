...
/** \mainpage RoboComp::real_sense_camera_to_laser
 *
 * \section intro_sec Introduction
 *
 * The real_sense_camera_to_laser component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/real_sense_camera_to_laser --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class real_sense_camera_to_laser : public RoboComp::Application
{
public:
	real_sense_camera_to_laser (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::real_sense_camera_to_laser::initialize()
{
...
int ::real_sense_camera_to_laser::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::real_sense_camera_to_laser app(prefix, startup_check_flag);
