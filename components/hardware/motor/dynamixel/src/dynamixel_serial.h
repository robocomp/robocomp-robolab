...
{
public:
	Dynamixel(RoboCompJointMotorSimple::MotorParams params, QMutex *m);
	~Dynamixel();

	virtual void initialize();
	RoboCompJointMotorSimple::MotorParams getMotorParams( uchar motor){ return this->params;};
	virtual void setPosition(const QString &motor,  float  pos, float maxSpeed);
	virtual void setSyncPosition( const QVector<Dynamixel::GoalPosition> & goals);
	virtual void getPosition(const QString &motor, float  &pos);
