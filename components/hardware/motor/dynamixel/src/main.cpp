...
/** \mainpage RoboComp::dynamixel
 *
 * \section intro_sec Introduction
 *
 * The dynamixel component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dynamixel --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dynamixel : public RoboComp::Application
{
public:
	dynamixel (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::dynamixel::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::dynamixel app(prefix, startup_check_flag);
