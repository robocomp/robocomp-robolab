 ...
 */
/** \mainpage RoboComp::hokuyoComp
 *
 * \section intro_sec Introduction
 *
 * The hokuyoComp manages the robot's laser device, processing of data provided by the laser.
 *
 ...
 * hokuyoComp provides odometry from differentialrobot
 *
 * \subsection install2_ssec Compile and install
 * cd robocomp/Components/HAL/laserComp
 * <br>
 * cmake . && make
 * <br>
 * To install:
 ...
 *
 * Just: "${PATH_TO_BINARY}/hokuyoComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class hokuyoComp : public RoboComp::Application
{
private:
...
int hokuyoComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	try
	{
		...
		Ice::ObjectAdapterPtr adapter = communicator()->createObjectAdapter("hokuyoComp");
