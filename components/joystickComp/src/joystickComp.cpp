 ...
 *
 * CammotionComp is a component to send joystikc movements to differentialRobotComp. Basically read joystick movements, transform then to speed orders and send to differentialRobotComp. It's a simple way to guide the robot.
 *
...
void JoyStickComp::initialize()
{
	...
	configGetInt( "Joy.MaxAdvance", joy_config.maxAdv, 120 );
