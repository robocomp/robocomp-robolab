 ...
 */
/** \mainpage RoboComp::joystickuniversalComp
 *
 * \section intro_sec Introduction
 *
 * The joystickuniversalComp component...
 *
 * \section interface_sec Interface
 *
 * joystickuniversalComp interface...
 *
 * \section install_sec Installation
 *
 * \subsection install1_ssec Software depencences
 * joystickuniversalComp ...
 *
 * \subsection install2_ssec Compile and install
 * cd joystickuniversalComp
 * <br>
 * cmake . && make
 * <br>
 * To install:
 ...
 *
 * <p>
 * The configuration file joystickuniversalComp/etc/config ...
 * </p>
 *
 * \subsection execution_ssec Execution
 *
 * Just: "${PATH_TO_BINARY}/joystickuniversalComp --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class joystickUniversalComp : public RoboComp::Application
{
private:
...
void joystickUniversalComp::initialize()
{
...
int joystickUniversalComp::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	Worker *worker = new Worker(joystickadapter_proxy);
	//Monitor thread
	...
	try
	{
		...
		rInfo("joystickUniversalComp started");
