...
/** \mainpage RoboComp::local_grid
 *
 * \section intro_sec Introduction
 *
 * The local_grid component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/local_grid --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class local_grid : public RoboComp::Application
{
public:
	local_grid (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::local_grid::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
	...
	tprx = std::make_tuple(camerargbdsimple_proxy,laser_proxy);
...
int main(int argc, char* argv[])
{
	...
	::local_grid app(prefix, startup_check_flag);
