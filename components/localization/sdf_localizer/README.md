...
## Dependencies
The following dependencies are required to build and run sdf_localiser. Ensure they are installed and properly configured on your system before proceeding:
```
<YOUR DEPENDENCIES>
```

## Configuration parameters
Like any other component, sdf_localiser requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/sdf_localiser etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
