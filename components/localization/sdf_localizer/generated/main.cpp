...
/** \mainpage RoboComp::sdf_localiser
 *
 * \section intro_sec Introduction
 *
 * The sdf_localiser component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/sdf_localiser --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "sdf_localiser"
#define SERVER_FULL_NAME   "RoboComp sdf_localiser::sdf_localiser"
...
class sdf_localiser : public Ice::Application
{
public:
	sdf_localiser (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData sdf_localiser::getInitializationDataIce(){
...
int sdf_localiser::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	sdf_localiser app(configFile, prefix, startup_check_flag);
