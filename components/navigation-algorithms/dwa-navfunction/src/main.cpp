...
/** \mainpage RoboComp::dwanavfunction
 *
 * \section intro_sec Introduction
 *
 * The dwanavfunction component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/dwanavfunction --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class dwanavfunction : public RoboComp::Application
{
public:
	dwanavfunction (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::dwanavfunction::initialize()
{
...
int ::dwanavfunction::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::dwanavfunction app(prefix, startup_check_flag);
