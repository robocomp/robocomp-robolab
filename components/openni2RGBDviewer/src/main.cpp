...
/** \mainpage RoboComp::openni2RGBDviewer
 *
 * \section intro_sec Introduction
 *
 * The openni2RGBDviewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/openni2RGBDviewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class openni2RGBDviewer : public RoboComp::Application
{
public:
	openni2RGBDviewer (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::openni2RGBDviewer::initialize()
{
...
int ::openni2RGBDviewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
