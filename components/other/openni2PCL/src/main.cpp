...
/** \mainpage RoboComp::openNI2pcl
 *
 * \section intro_sec Introduction
 *
 * The openNI2pcl component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/openNI2pcl --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class openNI2pcl : public RoboComp::Application
{
public:
	openNI2pcl (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::openNI2pcl::run(int argc, char* argv[])
{
