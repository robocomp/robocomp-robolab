...
/** \mainpage RoboComp::phidgetimu
 *
 * \section intro_sec Introduction
 *
 * The phidgetimu component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/phidgetimu --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
{
public:
	phidgetimu (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
