...
/** \mainpage RoboComp::rgbdViewer
 *
 * \section intro_sec Introduction
 *
 * The rgbdViewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/rgbdViewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class rgbdViewer : public RoboComp::Application
{
public:
	rgbdViewer (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int rgbdViewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
