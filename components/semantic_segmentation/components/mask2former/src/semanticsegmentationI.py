...
from RoboCompSemanticSegmentation import *

class SemanticSegmentationI(SemanticSegmentation):
    def __init__(self, worker):
        self.worker = worker


    def getInstances(self, c):
        return self.worker.SemanticSegmentation_getInstances()
    ...
    def getSegmentedImage(self, c):
        return self.worker.SemanticSegmentation_getSegmentedImage()
