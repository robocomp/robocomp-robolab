...
/** \mainpage RoboComp::sickLaser
 *
 * \section intro_sec Introduction
 *
 * The sickLaser component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/sickLaser --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class sickLaser : public RoboComp::Application
{
public:
	sickLaser (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int sickLaser::run(int argc, char* argv[])
{
