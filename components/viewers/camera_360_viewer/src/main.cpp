...
/** \mainpage RoboComp::Camera360Viewer
 *
 * \section intro_sec Introduction
 *
 * The Camera360Viewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/Camera360Viewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class Camera360Viewer : public RoboComp::Application
{
public:
	Camera360Viewer (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::Camera360Viewer::initialize()
{
...
int ::Camera360Viewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::Camera360Viewer app(prefix, startup_check_flag);
