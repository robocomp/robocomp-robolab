...
/** \mainpage RoboComp::camera_simple_viewer
 *
 * \section intro_sec Introduction
 *
 * The camera_simple_viewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/camera_simple_viewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class camera_simple_viewer : public RoboComp::Application
{
public:
	camera_simple_viewer (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
void ::camera_simple_viewer::initialize()
{
...
int ::camera_simple_viewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::camera_simple_viewer app(prefix, startup_check_flag);
