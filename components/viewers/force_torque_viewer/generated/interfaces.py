...
Ice.loadSlice("-I ./generated/ --all ./generated/ForceTorqueSensor.ice")
import RoboCompForceTorqueSensor
...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.ForceTorqueSensor = self.create_proxy("ForceTorqueSensor", RoboCompForceTorqueSensor.ForceTorqueSensorPrx, parameters["Proxies"]["ForceTorqueSensor"])
