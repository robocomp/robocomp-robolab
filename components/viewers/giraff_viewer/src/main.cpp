...
/** \mainpage RoboComp::giraff_viewer
 *
 * \section intro_sec Introduction
 *
 * The giraff_viewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/giraff_viewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class giraff_viewer : public RoboComp::Application
{
public:
	giraff_viewer (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::giraff_viewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::giraff_viewer app(prefix, startup_check_flag);
