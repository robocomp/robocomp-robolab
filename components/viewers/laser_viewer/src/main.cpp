...
/** \mainpage RoboComp::laser_viewer
 *
 * \section intro_sec Introduction
 *
 * The laser_viewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/laser_viewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class laser_viewer : public RoboComp::Application
{
public:
	laser_viewer (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::laser_viewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::laser_viewer app(prefix, startup_check_flag);
