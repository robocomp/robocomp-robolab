...
## Dependencies
The following dependencies are required to build and run lidar3dviewer. Ensure they are installed and properly configured on your system before proceeding:
...
Like any other component, lidar3dviewer requires a configuration file to start. In etc/config or etc/config.toml, you can find an example of the configuration file.
...
bin/lidar3dviewer etc/yourConfig # Execute the component
```
-----
-----
# Developer Notes
This section explains how to work with the generated code of lidar3dviewer, including what can be modified and how to use key features.
## Editable Files
