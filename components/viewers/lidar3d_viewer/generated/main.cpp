...
/** \mainpage RoboComp::lidar3dviewer
 *
 * \section intro_sec Introduction
 *
 * The lidar3dviewer component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/lidar3dviewer --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
#define PROGRAM_NAME    "lidar3dviewer"
#define SERVER_FULL_NAME   "RoboComp lidar3dviewer::lidar3dviewer"
...
class lidar3dviewer : public Ice::Application
{
public:
	lidar3dviewer (QString configFile, QString prfx, bool startup_check) { 
...
Ice::InitializationData lidar3dviewer::getInitializationDataIce(){
...
int lidar3dviewer::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	lidar3dviewer app(configFile, prefix, startup_check_flag);
