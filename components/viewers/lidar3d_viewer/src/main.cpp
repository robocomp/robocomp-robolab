...
class lidar3dviewer : public RoboComp::Application
{
public:
	lidar3dviewer (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int main(int argc, char* argv[])
{
	...
	::lidar3dviewer app(prefix, startup_check_flag);
