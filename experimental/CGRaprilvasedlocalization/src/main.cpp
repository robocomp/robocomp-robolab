...
/** \mainpage RoboComp::CGRaprilvasedlocalization
 *
 * \section intro_sec Introduction
 *
 * The CGRaprilvasedlocalization component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/CGRaprilvasedlocalization --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class CGRaprilvasedlocalization : public RoboComp::Application
{
public:
	CGRaprilvasedlocalization (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void CGRaprilvasedlocalization::initialize()
{
...
int CGRaprilvasedlocalization::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	CGRaprilvasedlocalization app(prefix);
