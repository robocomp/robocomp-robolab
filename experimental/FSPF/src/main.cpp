 ...
 *
 * Just: "${PATH_TO_BINARY}/FSPF --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class FSPF : public RoboComp::Application
{
public:
	FSPF (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int FSPF::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
