...
#
# Just: "${PATH_TO_BINARY}/Beacons --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
	...
	if status == 0:
		...
		adapter = ic.createObjectAdapter('Beacons')
		adapter.add(BeaconsI(worker), ic.stringToIdentity('beacons'))
		adapter.activate()
