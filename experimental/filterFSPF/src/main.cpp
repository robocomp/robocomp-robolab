...
/** \mainpage RoboComp::filterFSPF
 *
 * \section intro_sec Introduction
 *
 * The filterFSPF component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/filterFSPF --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class filterFSPF : public RoboComp::Application
{
public:
	filterFSPF (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int filterFSPF::run(int argc, char* argv[])
{
