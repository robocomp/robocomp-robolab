...
class mcmcCylinderFitting: public fitting
{
  // Define callback signature typedefs
  typedef void (sig_cb_fitting_addapt) (const boost::shared_ptr<Cylinder>&);

  pcl::PointCloud<PointT>::Ptr pointCloud2Fit;
  boost::shared_ptr<Cylinder> shape2Fit;
  boost::shared_ptr<Cylinder> bestFit;
  float weight;
  float bestweight;
...
public:
  mcmcCylinderFitting ( pcl::PointCloud<PointT>::Ptr cloud, QVec C, QVec S, QVec R );
  //Get and set cloud
  ...
  inline void setCylinder (boost::shared_ptr<Cylinder> shape) { shape2Fit=shape; }
  
  inline boost::shared_ptr<Cylinder> getCylinder () { return shape2Fit; }
  inline boost::shared_ptr<Cylinder> getBest () { return bestFit; }
