...
/** \mainpage RoboComp::infinitam
 *
 * \section intro_sec Introduction
 *
 * The infinitam component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/infinitam --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class infinitam : public RoboComp::Application
{
public:
	infinitam (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::infinitam::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
