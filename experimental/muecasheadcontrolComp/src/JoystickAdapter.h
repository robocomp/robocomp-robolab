...
void __read(::IceInternal::BasicStream*, JoystickAdapterPrx&);
void __patch__JoystickAdapterPtr(void*, ::Ice::ObjectPtr&);
...
struct AxisParams
{
    ...
    bool operator==(const AxisParams&) const;
    bool operator<(const AxisParams&) const;
...
struct ButtonParams
{
    ...
    bool operator==(const ButtonParams&) const;
    bool operator<(const ButtonParams&) const;
...
void __writeAxisList(::IceInternal::BasicStream*, const ::RoboCompJoystickAdapter::AxisParams*, const ::RoboCompJoystickAdapter::AxisParams*);
void __readAxisList(::IceInternal::BasicStream*, AxisList&);

typedef ::std::vector< ::RoboCompJoystickAdapter::ButtonParams> ButtonsList;
void __writeButtonsList(::IceInternal::BasicStream*, const ::RoboCompJoystickAdapter::ButtonParams*, const ::RoboCompJoystickAdapter::ButtonParams*);
void __readButtonsList(::IceInternal::BasicStream*, ButtonsList&);
...
public:
    ...
    ::IceInternal::ProxyHandle<JoystickAdapter> ice_context(const ::Ice::Context& __context) const
    {
        ...
        return dynamic_cast<JoystickAdapter*>(_Base::ice_context(__context).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_adapterId(__id).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_endpoints(__endpoints).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_locatorCacheTimeout(__timeout).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_connectionCached(__cached).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_endpointSelection(__est).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_secure(__secure).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_preferSecure(__preferSecure).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_router(__router).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_locator(__locator).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_collocationOptimized(__co).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_twoway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_oneway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_batchOneway().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_datagram().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_batchDatagram().get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_compress(__compress).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_timeout(__timeout).get());
    #else
    ...
    #if defined(_MSC_VER) && (_MSC_VER < 1300) // VC++ 6 compiler bug
        typedef ::IceProxy::Ice::Object _Base;
        return dynamic_cast<JoystickAdapter*>(_Base::ice_connectionId(__id).get());
    #else
...
public:
    ...
    virtual void sendData(const ::RoboCompJoystickAdapter::TData&, const ::Ice::Context*) = 0;
};
...
public:
    ...
    virtual void sendData(const ::RoboCompJoystickAdapter::TData&, const ::Ice::Context*);
};
