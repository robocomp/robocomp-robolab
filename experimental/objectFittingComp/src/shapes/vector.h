...
// // Inline extrema
// inline int ffmin(const int a, const int b)
// {
//   return (a<b?a:b);
// }
// 
// inline int ffmax(const int a, const int b)
// {
//   return (a>b?a:b);
// }
// 
...
// }
//   
inline double vector_max(const double &a, const double &b, const double &c)
{
   return (a>b)?((a>c)?a:c):((b>c)?b:c);
}
...
{
  return vector_max(fabs(u.x),fabs(u.y),fabs(u.z));
}
