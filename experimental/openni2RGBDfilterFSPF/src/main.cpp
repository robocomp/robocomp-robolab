...
/** \mainpage RoboComp::openni2RGBDfilterFSPF
 *
 * \section intro_sec Introduction
 *
 * The openni2RGBDfilterFSPF component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/openni2RGBDfilterFSPF --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class openni2RGBDfilterFSPF : public RoboComp::Application
{
public:
	openni2RGBDfilterFSPF (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void openni2RGBDfilterFSPF::initialize()
{
...
int openni2RGBDfilterFSPF::run(int argc, char* argv[])
{
...
int main(int argc, char* argv[])
{
	...
	openni2RGBDfilterFSPF app(prefix);
