...
/** \mainpage RoboComp::trajectoryDirector
 *
 * \section intro_sec Introduction
 *
 * The trajectoryDirector component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/trajectoryDirector --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class trajectoryDirector : public RoboComp::Application
{
public:
	trajectoryDirector (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void trajectoryDirector::initialize()
{
...
int trajectoryDirector::run(int argc, char* argv[])
{
