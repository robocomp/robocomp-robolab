...
/** \mainpage RoboComp::Visor3D
 *
 * \section intro_sec Introduction
 *
 * The Visor3D component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/Visor3D --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class Visor3D : public RoboComp::Application
{
public:
	Visor3D (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int Visor3D::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
