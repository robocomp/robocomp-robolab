...
/** \mainpage RoboComp::visualKinematicOptimization
 *
 * \section intro_sec Introduction
 *
 * The visualKinematicOptimization component...
 *
 ...
 * cd visualKinematicOptimization
 * <br>
 * cmake . && make
 * <br>
 * To install:
 ...
 *
 * Just: "${PATH_TO_BINARY}/visualKinematicOptimization --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class visualKinematicOptimization : public RoboComp::Application
{
public:
	visualKinematicOptimization (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::visualKinematicOptimization::initialize()
{
...
int ::visualKinematicOptimization::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::visualKinematicOptimization app(prefix);
