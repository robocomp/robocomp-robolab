...
/**
* \brief Ice Methods to read from file
* @param name String indicating param name
* @param value Value readed from config file
* @param default_value Value assined if value readed from config file isn't valid
* @return  bool Indicate param read correctly
*/
bool GenericMonitor::configGetString( const std::string name, std::string &value,  const std::string default_value)
{
